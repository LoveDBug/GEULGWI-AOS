...
class LoginViewModelTest {
    ...
    @Test
    fun `이메일 변경 - 빈 문자열일 때 에러`() = runTest {
    ...
    @Test
    fun `이메일 변경 - 유효한 이메일일 때 에러 없음`() = runTest {
        val viewModel = LoginViewModel(FakeNavigator())
    ...
    @Test
    fun `비밀번호 변경 - 빈 문자열일 때 에러`() = runTest {
        val viewModel = LoginViewModel(FakeNavigator())
    ...
    @Test
    fun `비밀번호 변경 - 유효한 패스워드일 때 에러 없음`() = runTest {
        val viewModel = LoginViewModel(FakeNavigator())
    ...
    @Test
    fun `빈 자격 증명으로 로그인 클릭 시 이메일·패스워드 에러, 사이드 이펙트 발생`() = runTest {
        val viewModel = LoginViewModel(FakeNavigator())
    ...
    @Test
    fun `유효한 자격 증명으로 로그인 클릭 시 로딩 상태로 변경, 에러 없음`() = runTest {
        val viewModel = LoginViewModel(FakeNavigator())
